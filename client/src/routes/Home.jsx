...
const Home = () => {
    ...
    return (
        <div className='flex flex-col p-8 items-center gap-8'>
            <h1 className='text-6xl text-black underline py-20 text-center'>
                Friends Don&apos;t Lie
            </h1>
            <h2 className='text-xl text-black mb-8'>
                Enter a Name to start a game!
            </h2>
            <div>
                <div className='relative h-12 w-full min-w-[200px]'>
                    <input
                        ...
                        form='username'
                        type='text'
                        className='form-textbox peer h-full w-full border-b border-black bg-transparent pt-4 pb-1.5 text-sm font-normal text-black outline outline-0 transition-all placeholder-shown:border-black focus:border-[#1B998B] focus:outline-0 disabled:border-0 disabled:bg-black'
                        onChange={e =>
